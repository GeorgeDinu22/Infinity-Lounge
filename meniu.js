...
ContainerImgMeniu.forEach(container =>{
    ...
    if(ItemSelectorSideBar[0]){
        ItemSelectorSideBar[0].addEventListener('click',(event)=>{
            ...
            if(sessionStorage.getItem('Medgedia') === 'true'){
                window.location.href = 'meniu-medgedia.html';
            }
            else {
    ...
    if (LogoMeniu){
        if(sessionStorage.getItem('Medgedia') === 'true'){
            LogoMeniu.src = "logo-medgedia.png";
        }
    }
    ...
    if (LogoSite){
        LogoSite.addEventListener('click',(e)=>{
            ...
            e.preventDefault();
            if(sessionStorage.getItem('Medgedia') === 'true'){
                window.location.href = 'acasa-medgedia.html';
        }
        else {
